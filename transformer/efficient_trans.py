...
from transformer.test_detransformer import Transform
...
class EfficientDetBackbone(nn.Module):
    def __init__(self, num_classes=80, phi=0, load_weights=False):
        ...
        self.Transformer = Transform(hidden_dim= 352,num_feats = 176)
        self.conv_project = SeparableConvBlock(880,352, onnx_export=False)
        self.relu = nn.ReLU()
        # -------------------------------------------#
        #   获得三个shape的有效特征层
        #   分别是C3  64, 64, 40
