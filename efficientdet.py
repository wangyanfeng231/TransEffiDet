...
class EfficientDet(object):
    _defaults = {
        "model_path"    : '/home/zyq/zyq/home/efficientdet-pytorch-master/logs_cat4halfInput/Epoch150-Total_Loss0.1776-Val_Loss0.2255.pth',
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf',size=np.floor(3e-2 * np.shape(image)[1] + 1).astype('int32'))
